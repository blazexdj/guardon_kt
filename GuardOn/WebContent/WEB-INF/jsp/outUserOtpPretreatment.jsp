...
<script type="text/javascript">
	...
	function pageMove(){
		location.href = "./outUserOtpPretreatment.do?page="+asyncPaging.options.currentPage;
	}
</script>
<script type="text/javascript">
$(function() {		
...
<div class="container">
  <div class="header"><strong>
    <!-- end .header -->
  Guard-ON</strong> 비밀번호 발급서버 리스트(외부)</div>
  <div class="sidebar1">
    <ul class="nav">
 ...
 <div class="content">
 <center>
 <form action="userOtp.do" method="post" name="check">
 <table id="tablesorter-demo" class="tablesorter" border="0" cellpadding="0" cellspacing="1">
 	...
 	<input type="button" value="OTP 발급" onclick="emptyCheck()" >
   <!--  <input type="submit" value="OTP 발급" onclick="emptyCheck()"/>-->
	<br/>
	<br/>
	</form>
</center>
