...
<!-- end .sidebar1 --></div>
       ...
       <input name="userCp2" type="text" maxlength="4" style="width:100px; height:20px;" value=${userCp2 } class="format" style="ime-mode:disabled;" onkeydown="return onlyNumber(event)"/>
       &nbsp; &nbsp;-&nbsp; &nbsp; 
