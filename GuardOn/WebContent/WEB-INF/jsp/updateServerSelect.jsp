...
<div class="container">
 ...
 <div class="content">
 <center>
  <form action="updateServerPretreatment.do" method="post">
  	<table>
     	<tr>
        	<th></th>
            <th>서버명</th>
         ...
         <c:forEach var="i" items="${serverList}">
         	<tr>
              <td><input type="radio" name="temp" value="${i.serverName}" /></td>
              <td>${i.serverName}</td>
     ...
     <br>
     	<div id="align">
     <div id="paging" style="height:100px; margin-left: 250px"></div>
     <input id="currentPage" type="hidden" value="${page}" />	
     <input id="serverListCount" type="hidden" value="${serverListCnt}" />
 		</div>
   <input type="submit" value="수  정" style="height: 50px; width: 80px"/>
	<br/>
	<br/>
	</form>
</center>
  ...
  <script>
	...
	function pageMove(){
		location.href = "./updateServerSelect.do?page="+asyncPaging.options.currentPage;
	}
</script>
</body>
</html>
